...
public class RegistroServiceImpl implements RegistroService {
    ...
    //metodo que es llamdo al dar click en el correo, usetra una vista para completar el proceso de activacion
    @Override
...
// metodo al darle submit al activar
    ...
    @Override
    public Model crearUsuario(Model model, Usuario usuario)throws MessagingException {String mensaje;
        if (!usuarioService.
